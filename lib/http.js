...
var Http = {
		...
		if (this.availablePool.length) {
			...
			var timerCallback = function() {
				if (Http.availablePool.length) {
					transport = Http.availablePool.unshift();
	...
	/**
	 * Http.get(options) -> Http.Transport.AbstractPromise
	...
	/**
	 * Http.post(options) -> Http.Transport.AbstractPromise
	 * - options (Object): Transport config options.
	 * 
	...
	/**
	 * Http.put(options) -> Http.Transport.AbstractPromise
	 * - options (Object): Transport config options.
	 * 
	...
	/**
	 * Http.del(options) -> Http.Transport.AbstractPromise
	 * - options (Object): Transport config options.
	 * 
	...
	/**
	 * Http.head(options) -> Http.Transport.AbstractPromise
	 * - options (Object): Transport config options.
	 * 
