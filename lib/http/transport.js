...
Http.Transport.prototype = {
	 ...
	 * - paramKeySeparator (String): Values are null or "."
	 *                               When null: keys are flattened with square brackets
	 *                               separating the keys:
	 *                                 Params: { a: { b: 123 } }
	 *                                 Becomes: "a[b]=123"
	 *                               When ".": Keys are flattened separated by dots
	 *                                 Params: { a: { b: 123 } }
	 *                                 Becomes: "a.b=123"
	...
	_serializeParams: function(params) {
		if (!params) {
			...
			for (var key in params) {
				...
				queryString.push(escape(key) + "=" + value);
			}
	...
	_serializeObject: function _serializeObject(obj, values, prefix, suffix) {
		values = values || [];
		var key, value = "", name = "", type;
